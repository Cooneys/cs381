...
-- | Helper function for isBST and inBST
nodeVal :: Tree -> Int
nodeVal (Leaf i)     = i
nodeVal (Node n _ _) = n
...
maxInt :: Tree -> Int 
maxInt (Leaf i)     = i
maxInt (Node n l r) = foldr1 max [n, (maxInt l), (maxInt r)]
...
minInt :: Tree -> Int
minInt (Leaf i)     = i
minInt (Node n l r) = foldr1 min [n, (minInt l), (minInt r)]
...
sumInts :: Tree -> Int
sumInts (Leaf i)     = i
sumInts (Node n l r) = foldr1 (+) [n, (sumInts l), (sumInts r)]
...
preorder :: Tree -> [Int]
preorder (Leaf i)     = [i]
preorder (Node n l r) = foldr1 (++) [[n], (preorder l), (preorder r)]
...
inorder :: Tree -> [Int]
inorder (Leaf i)     = [i]
inorder (Node n l r) = foldr1 (++) [(inorder l), [n], (inorder r)]
...
isBST :: Tree -> Bool
isBST (Leaf i)     = True
isBST (Node n l r) = n < (nodeVal r) && (nodeVal l) < n && isBST l && isBST r
...
inBST :: Int -> Tree -> Bool
inBST i (Leaf l)     = i == l
inBST i (Node n l r) = i == n || inBST i l || inBST i r
